  ...
  "rounded-2xl border bg-card text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        gradient: "bg-gradient-to-br from-card to-muted border-0 shadow-sm hover:shadow-md",
        feature: "bg-card hover:bg-card/80 shadow-sm hover:shadow-lg hover:-translate-y-1",
      },
    },
    defaultVariants: {
      variant: "default",
